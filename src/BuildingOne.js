...
import b11 from './building/b1/b11.jpg';
import b12 from './building/b1/b12.jpg';
import b13 from './building/b1/b13.jpg';
import './App.css';
...
class BuildingOne extends Component {
  constructor(props) {
    super(props);
        ...
        <header className="App-header">
          ...
          <Container>
            <Row>
              ...
              <Col><a href="/buildingTwo"><Button outline color="success">next</Button></a></Col>
            </Row><br></br>
          </Container>
        </header>
